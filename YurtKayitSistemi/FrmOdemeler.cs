...
namespace YurtKayitSistemi
{
    public partial class FrmOdemeler : Form
    {
        ...
        {   //Datagridden seçilen kısmın verilerinin textboxda gösterimi
            int secilen;
        ...
        private void BtnoOdemeAl_Click(object sender, EventArgs e)
        {   //Ödenen tutardan kalan borcu hesaplıyoruz
            ...
            //Yeni Tutarı Veri Tabanında Kaydetme İşlemi
